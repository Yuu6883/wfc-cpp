 ...
 */
std::vector<double> get_plogp(
    const std::vector<double> &distribution) noexcept {
...
Wave::Wave(unsigned height, unsigned width,
    ...
    memoisation.nb_patterns = std::vector<unsigned>(
        width * height, static_cast<unsigned>(nb_patterns));

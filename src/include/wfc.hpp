...
class WFC {
   private:
    ...
    /**
     * Transform the wave to a valid output (a 2d array of patterns that aren't
     * in contradiction). This function should be used only when all cell of the
     * wave are defined.
     */
   ...
   public:
     ...
     */
    void remove_wave_pattern(unsigned i, unsigned j,
